...
dialog.add(sFarmer, "Well hello and howdy there nephew!");
...
dialog.add(sFarmer, "But we gotta start small, so et a New Pumpkin and get to smashin' with yer hammer!");
